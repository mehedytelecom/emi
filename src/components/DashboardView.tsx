...
export const DashboardView: React.FC<DashboardViewProps> = ({
  ...
  return (
    <div className="space-y-6 pb-16 lg:pb-8">
      {/* Top Banner / Welcome */}
      <div className="p-4 sm:p-6 rounded-3xl bg-linear-to-br from-slate-900 via-slate-800 to-slate-950 text-white shadow-xl border border-slate-800 flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <h1 className="text-xl sm:text-3xl font-black tracking-tight mt-1 leading-tight">
      ...
      {/* Primary KPI Metrics Grid (Responsive 2-col on mobile, 4-col on desktop) */}
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-2.5 sm:gap-4">
        {/* Card 1: Today's Due */}
        <div className="p-3.5 sm:p-5 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-xs">
          <div className="flex items-center justify-between">
            <span className="text-[11px] sm:text-xs font-bold text-slate-500 dark:text-slate-400">Due Today</span>
          ...
          <div className="mt-2 sm:mt-3">
            <span className="text-lg sm:text-2xl font-black text-slate-900 dark:text-white block truncate">
              {formatCurrency(dueTodayTotal)}
            </span>
            <span className="text-[11px] sm:text-xs text-amber-600 dark:text-amber-400 font-semibold mt-0.5 block truncate">
              {dueTodayInstallments.length} installment{dueTodayInstallments.length !== 1 ? 's' : ''}
            </span>
          </div>
        </div>
        ...
        <div className="p-3.5 sm:p-5 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-xs">
          <div className="flex items-center justify-between">
            <span className="text-[11px] sm:text-xs font-bold text-slate-500 dark:text-slate-400">Collected Today</span>
            <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-xl bg-emerald-500/10 text-emerald-500 flex items-center justify-center">
              <TrendingUp className="w-3.5 h-3.5 sm:w-4 sm:h-4" />
            </div>
          </div>
          <div className="mt-2 sm:mt-3">
            <span className="text-lg sm:text-2xl font-black text-emerald-600 dark:text-emerald-400 block truncate">
              {formatCurrency(todayCollectedTotal)}
            </span>
            <span className="text-[11px] sm:text-xs text-slate-500 font-medium mt-0.5 block truncate">
        ...
        <div
          ...
          className="p-3.5 sm:p-5 rounded-3xl bg-white dark:bg-slate-900 border border-red-200 dark:border-red-950/80 shadow-xs cursor-pointer hover:border-red-400 transition"
        >
          <div className="flex items-center justify-between">
            <span className="text-[11px] sm:text-xs font-bold text-red-600 dark:text-red-400">Total Overdue</span>
            <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-xl bg-red-500/10 text-red-500 flex items-center justify-center">
              <AlertTriangle className="w-3.5 h-3.5 sm:w-4 sm:h-4" />
            </div>
          </div>
          <div className="mt-2 sm:mt-3">
            <span className="text-lg sm:text-2xl font-black text-red-600 dark:text-red-400 block truncate">
              {formatCurrency(overdueTotal)}
            </span>
            <span className="text-[11px] sm:text-xs text-slate-500 font-medium mt-0.5 flex items-center gap-1 truncate">
        ...
        <div className="p-3.5 sm:p-5 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-xs">
          <div className="flex items-center justify-between">
            <span className="text-[11px] sm:text-xs font-bold text-slate-500 dark:text-slate-400">Total Outstanding</span>
            <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-xl bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 flex items-center justify-center">
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2">
            ...
            <div className="flex items-center gap-1 overflow-x-auto pb-1 sm:pb-0">
              <button
                ...
                className={`px-2.5 py-1.5 rounded-xl text-[11px] font-bold whitespace-nowrap transition cursor-pointer ${
